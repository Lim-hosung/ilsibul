...
const aboutTabs = [
    ...
    { name: '연혁', nameEn: 'History', href: '/about/history', bannerImage: '/images/hero/3d-steel-2.png' },
    { name: 'CEO 인사말', nameEn: 'CEO Message', href: '/about/ceo', bannerImage: '/images/hero/3d-steel-1.png' },
    { name: '찾아오시는길', nameEn: 'Location', href: '/about/location', bannerImage: '/images/hero/3d-steel-2.png' },
];
